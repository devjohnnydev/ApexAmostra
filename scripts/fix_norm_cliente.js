...
function normalizeCliente(row) {
    ...
    const strAtualizado = cleanString(row.atualizado);
    const booleanAtualizado = strAtualizado && strAtualizado.toUpperCase() === 'SIM' ? true : false;
...
`;
fs.writeFileSync('c:/Users/Professor/Desktop/ApexAmostra/apextech/lib/normalizeCliente.js', contentNorm);
